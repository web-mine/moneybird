...
describe Moneybird::Resource::Administration do
  ...
  let(:administration) { Moneybird::Resource::Administration.new(client, {id: 123}) }
  ...
  it "has a list of sales invoices" do
    ...
    sales_invoices = administration.sales_invoices
  ...
  it "has a list of estimates" do
    ...
    estimates = administration.estimates
  ...
  it "has a list of tax_rates" do
    ...
    tax_rates = administration.tax_rates
  ...
  it "has a list of recurring_sales_invoices" do
    ...
    recurring_sales_invoices = administration.recurring_sales_invoices
  ...
  it "has a list of identities" do
    ...
    identities = administration.identities
  ...
  it "has a list of financial_mutations" do
    ...
    financial_mutations = administration.financial_mutations
  ...
  it "has a list of financial_accounts" do
    ...
    financial_accounts = administration.financial_accounts
